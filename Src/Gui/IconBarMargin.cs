...
// ***********************************************************************
// <copyright file="IconBarMargin.cs" company="">
...
namespace Zeroit.Framework.CodeEditor.TextEditor
{
	...
	public class IconBarMargin : AbstractMargin
	{
		...
		public override void Paint(Graphics g, Rectangle rect, Color BackColor)
		{
			...
			// paint background
			g.FillRectangle(new SolidBrush(BackColor), new Rectangle(drawingPosition.X, rect.Top, drawingPosition.Width - 1, rect.Height));
